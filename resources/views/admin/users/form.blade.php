      ...
      <form method="POST" action="{{ route('admin.saveUser') }}" id="userForm">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="email" placeholder="Email Address" value="{{ $user->email }}" @if($user->email) readonly @endif/>
            @if ($errors->has('email'))
          ...
          <div class="form-group col-md-4">
            <label class="form-control-label">Address Wallet</label>
            <input type="text" class="form-control" name="address_vallet" placeholder="Address Wallet" value="{{ $user->address_vallet }}"/>
          </div>
          <!-- <div class="form-group col-md-4">
